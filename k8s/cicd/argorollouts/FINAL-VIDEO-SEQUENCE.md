...
- ✅ frontend-preview를 NodePort (30844)로 설정
...
**설명**: "Preview에서 롤백 버전을 확인합니다. 크리스마스가 없습니다"
...
1. **초기 상태**: 크리스마스 버전 (Hello 크리스마스 있음)
2. **롤백**: 이전 버전 (Hello 크리스마스 없음)
3. **다시 롤백**: 크리스마스 버전 (Hello 크리스마스 다시 나타남)
4. **Preview 접속**: http://192.168.0.170:30844 (NodePort)
